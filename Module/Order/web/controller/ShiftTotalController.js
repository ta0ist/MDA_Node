...
cols.push({ field: "SHIFT_NAME", title: lang.Order.ShiftName, width: 80, sortable: true, filterable: { extra: false }, hidden: false });
//cols.push({
//    field: "MEN_NO", title: "人员编号", width: 80, sortable: true, filterable: { extra: false }, hidden: false
//});
cols.push({ field: "MEM_NAME", title: lang.Common.StaffName, width: 80, sortable: true, filterable: false, hidden: false });
cols.push({ field: "TASK_NO", title: lang.Common.ProductionPlan, width: 80, sortable: true, filterable: false });
cols.push({ field: "PLAN_TYPE", title: lang.Common.ProjectType, width: 80, sortable: true, filterable: { extra: false } });
cols.push({ field: "PROD_NAME", title: lang.Common.ProductName, width: 80, sortable: true, filterable: false });
cols.push({ field: "PROC_NO", title: lang.Common.ProcessId, width: 80, sortable: true, filterable: false });
cols.push({ field: "PROC_NAME", title: lang.Common.ProcessName, width: 80, sortable: true, filterable: false });
cols.push({ field: "MAC_NAME", title: lang.EmployeePerformance.DeviceName, width: 80, sortable: true, filterable: false });
cols.push({ field: "RUN_TIME", title: lang.Common.RunIt, width: 80, sortable: true, filterable: false });
cols.push({ field: "STOP_TIME", title: lang.Common.StopIt, width: 80, sortable: true, filterable: false });
cols.push({ field: "PROD_COUNT", title: lang.Common.Output, width: 80, sortable: true, filterable: false });
