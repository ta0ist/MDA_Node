...
$(function () {
    ...
    var cols = [];
    cols.push({ field: "PROD_NO", title: "产品编号", width: 80, sortable: true, filterable: false, hidden: false });
    ...
    cols.push({ field: "TASK_NO", title: "工单号", width: 80, sortable: true, filterable: false, hidden: false });
    ...
    cols.push({ field: "REPORT_DATE", title: "派工日期", width: 80, sortable: true, filterable: true, hidden: false, format: "{0: yyyy/MM/dd HH:mm:ss}" });
    cols.push({ field: "END_DATE", title: "计划结束日期", width: 80, sortable: true, filterable: false, hidden: true, format: "{0: yyyy/MM/dd HH:mm:ss}" });
    ...
    cols.push({ field: "INFERIOR_NAME", title: "原因名称", width: 80, sortable: true, filterable: false, hidden: false });
    ...
    cols.push({ field: "INFERIOR_NUM", title: "次品数", width: 80, sortable: true, filterable: false, hidden: false });
    ...
    cols.push({ field: "MAN_NAMES", title: "操作人员", width: 120, sortable: true, filterable: false, hidden: false });
...
function gridr(data, type) {
    ...
    var ydata = [];
    var ur, title;
    if (type == 1) { $("#gridr").empty() }
    else if (type == 2) { $("#gridm").empty() }
    else { $("#gridp").empty() }
