 ...
 app.controller('statusctrl', ['$scope', '$http', function($scope, $http) {
     ...
     function onChange() {
         ...
         $("#downMemu").toggleClass(lang.Common.Unplanned, value == 0).toggleClass(lang.Common.InThePlan, value == 1).toggleClass(lang.Common.Without, value == 2);
     };
     //初始化画板
 ...
 function getStatusData() {
     ...
     $.post("/statusdata/GetStatusData", null, function(data) {
         ...
         for (var m in array) {
             ...
             //计算偏移量
             var xx = x + machine_width + space_Horizontal + k * (status_w + space_Horizontal),
                 yy = y;
             //绘制连线
                     ...
                     .click(function(e) {
                         ...
                         if (objdata.LEVEL == 1) {
                             ...
                             selectDelete = paper.image("./Common/web/images/Delete.png", x + status_w + 7, y + status_h - 6, 12, 12)
                                 .click(function() {
                                     //删除状态
                                     BzConfirm(lang.Common.DeleteState, function(e) {
                                         if (e) {
                         ...
                         paper.rect(xx, yy + (n + 1) * (status_h + space_Vertical), status_w, status_h, 0)
                             ...
                             .click(function() {
                                 ...
                                 validator = $("#viewmodel").validate({
                                     ...
                                     messages: {
                                         add_ID: {
                                             required: lang.Common.NotEmpty,
                                             maxlength: lang.Common.IntegerWithin,
                                             digits: lang.Common.PleaseEnterAnInteger
                                         },
                                         add_Name: { required: lang.Common.NotEmpty }
                                     }
                                 });
                             });
                     }
