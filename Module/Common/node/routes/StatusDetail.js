...
module.exports=function(app){
    ...
    //app.get('/GetAllMachineAndMachineGroup',StatusDetailctrl.GetAllMachineAndMachineGroup);
    //app.get('/GetMachineStatusListByName',StatusDetailctrl.GetMachineStatusListByName);
}