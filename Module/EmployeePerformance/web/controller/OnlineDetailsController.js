...
app.controller('OnlineDetailsCtrl', function($scope) {
    ...
    cols.push({ field: "MAC_NAME", title: lang.Order.DeviceName, width: 80, sortable: true, filterable: false, filterable: { extra: false } });
    cols.push({ field: "START_DATE", title: lang.EmployeePerformance.LoginDate, width: 120, format: "{0: yyyy/MM/dd HH:mm:ss}", sortable: true, filterable: false });
    cols.push({ field: "END_DATE", title: lang.EmployeePerformance.LogOutOfDate, width: 120, format: "{0: yyyy/MM/dd HH:mm:ss}", sortable: true, filterable: false });
    cols.push({ field: "MEM_NAME", title: lang.EmployeePerformance.LogOnToStaff, width: 80, sortable: true, filterable: false, filterable: { extra: false } });
    cols.push({ field: "LOGIN_STATE", title: lang.EmployeePerformance.Event, width: 80, sortable: true, filterable: false, template: kendo.template($("#LOGIN_STATE").html()) });
    ...
    $scope.search = function() {
        if ($("#startTime").data("kendoDatePicker").value() == null && $("#endTime").data("kendoDatePicker").value() == null) {
            BzAlert(lang.Order.PleaseInputTheCorrectDate);
            return;
        } else {
