...
$.ligerui.controls.Grid.prototype.showFilter = function (txtname1, txtname2) {
    ...
    return g.winfilter = $.ligerDialog.open({
        ...
        buttons: [
            { text: txtname1, onclick: function (item, dialog) { loadData(); dialog.hide(); } },
            { text: txtname2, onclick: function (item, dialog) { dialog.hide(); } }
            ]
    });
    ...
    function getFields() {
        ...
        fields.shift();//因为表格带序号列，所以删除序号列名称
        return fields;
    }
